...
if (isset($_POST['submit'])) {
  $resultado = [
    'error' => false,
    'mensaje' => 'El padre ' . escapar($_POST['nombres']) . ' ha sido agregado con éxito'
  ];
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO padre_estudiante (
      dni, nombres, apellido_paterno, apellido_materno, edad, telefono
      )";
      $consultaSQL .= " VALUES (:" . implode(", :", array_keys($padre)) . ")";
  
      $sentencia = $conexion->prepare($consultaSQL);
      $sentencia->execute($padre);
  
    } catch(PDOException $error) {
      $resultado['error'] = true;
      $resultado['mensaje'] = 'Error al agregar padre: ' . $error->getMessage();
    }
}
?>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Padre del alumno</h2>
      <hr>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-primary" href="crearMadre.php">Avanzar</a>
