...
if (isset($_POST['submit'])) {
  $resultado = [
    'error' => false,
    'mensaje' => 'La madre ' . escapar($_POST['nombres']) . ' ha sido agregado con éxito'
  ];
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO madre_estudiante (
    dni, nombres, apellido_paterno, apellido_materno, edad, telefono
    )";
    $consultaSQL .= " VALUES (:" . implode(", :", array_keys($madre)) . ")";

    $sentencia = $conexion->prepare($consultaSQL);
    $sentencia->execute($madre);

  } catch(PDOException $error) {
    $resultado['error'] = true;
    $resultado['mensaje'] = 'Error al agregar madre: ' . $error->getMessage();
  }
}
?>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Madre del alumno</h2>
      <hr>
      <form method="post">
